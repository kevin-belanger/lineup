...
class OtherTeacherRequests extends Component
{
    ...
    public function render(): View
    {
        return view('livewire.teacher.other-teacher-requests', [
            'requests' => SupportRequest::query()
                ->with(['student:id,first_name,last_name,deleted_at', 'classroom:id,requires_table_number', 'subject:id,name,url', 'fieldAnswers', 'assignedTeacher:id,first_name,last_name,deleted_at', 'priorityRequester:id,first_name,last_name,deleted_at'])
    ...
    private function managedRequest(): ?SupportRequest
    {
        ...
        return $this->manageableRequestQuery($this->managingRequestId)
            ->with(['student:id,first_name,last_name,deleted_at', 'classroom:id,requires_table_number', 'subject:id,name,url', 'fieldAnswers', 'assignedTeacher:id,first_name,last_name,deleted_at'])
            ->first();
    }
